				...
				{cartItem === 0 ? (
					...
					<>
						<div className="flex m-5 space-x-4 items-center justify-around">
						 ...
						 <MenuItem sx={{ backgroundColor: "#f97316", borderRadius: 2, marginX: 2, marginY: 1, color: "white", display: "flex", justifyContent: "center", fontWeight: 600, ":hover":{backgroundColor:"#dc7135"}}} >Checkout</MenuItem>
					</>)}
			</Menu>
		</>
	);
